...
fn test_batted_ball() {
    ...
    for _ in 0..1000 {
            ...
            == SwingExecution::Take
        {
            ...
            let contact = evaluate_swing_contact(&mut rng, &batter, &displacement, &swing_error);

            (displacement, swing_error, contact)
        };

        let batted_ball = if swing_contact.adjusted_contact_type == SwingContactType::Take
            || swing_contact.adjusted_contact_type == SwingContactType::SwungAndMiss
        {
            BattedBall::default()
        } else {
        ...
        conn.execute(
            ...
            timing_impact_x_m, offset_x_m, offset_z_m, thickness_offset_m, length_offset_m, original_contact_type, adjusted_contact_type, modified_attack_angle_deg,
            ...
            params![
                ...
                swing_contact.timing_impact_x_m, swing_contact.offset_x_m, swing_contact.offset_z_m, swing_contact.thickness_offset_m, swing_contact.length_offset_m, swing_contact.original_contact_type.as_ref(), swing_contact.adjusted_contact_type.as_ref(), swing_contact.attack_angle_deg,
