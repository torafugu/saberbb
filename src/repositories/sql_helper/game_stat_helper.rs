...
const INSERT_PLAYER_GAME_BATTING_SQL: &str = "INSERT INTO player_game_batting (
        ...
        approach_variation_deg, pull_bias_deg, timing_angle_error, final_hla_deg, length_offset_m,
        original_contact_type, adjusted_contact_type, launch_speed,
        launch_angle, polar_distance, polar_angle, total_time, first_bounce_distance, first_bounce_angle, first_bounce_time,
...
pub fn insert_player_game_batting(
    ...
    db_client.execute_tx(
        ...
        params![
            ...
            player_game_batting.approach_variation_deg,
            player_game_batting.pull_bias_deg,
            player_game_batting.timing_angle_error,
            player_game_batting.final_hla_deg,
            player_game_batting.length_offset_m,
            player_game_batting.original_contact_type.as_ref(),
            player_game_batting.adjusted_contact_type.as_ref(),
