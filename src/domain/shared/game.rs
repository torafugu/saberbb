...
impl GameResult {
    ...
    pub fn add_player_batting(
        ...
        let player_batting = PlayerGameBatting {
            ...
            approach_variation_deg: metrics.approach_variation_deg,
            pull_bias_deg: metrics.pull_bias_deg,
            timing_angle_error: metrics.timing_angle_error,
            final_hla_deg: metrics.final_hla_deg,
            length_offset_m: metrics.length_offset_m,
            original_contact_type: metrics.original_contact_type,
            adjusted_contact_type: metrics.adjusted_contact_type,
            ball: ball,
