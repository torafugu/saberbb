...
use crate::domain::resolver::fielding_timing::DefenseTimeCalculator;
...
fn infield_grounder_defense_play(
    ...
    let result = calculator.infield_play_time(
        ...
        throw_target.base,
        throw_target.play_type == PlayType::ForcePlay,
        throw_target.final_fielder_position,
    );
...
fn is_ball_in_fielder_lane(fielder: &ActiveFielder, ball_angle: f64) -> bool {
    ...
    (fielder.angle() - ball_angle).abs() <= fielder.info.coverage_angle()
}
