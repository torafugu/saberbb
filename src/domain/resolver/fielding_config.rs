...
pub const FENCE_BOUNCE_COEFF: f64 = 0.25; // Fence bounce coefficient (grounder cushion is quite damped)
...
pub const LINER_REACTION_TIME: f64 = 0.15; // TODO: should be moved to Player ability
pub const TOUCH_PENALTY_TIME: f64 = 0.3;
pub const FIRST_BOUNCE_TIME: f64 = 0.5; // At least 0.5s after the first bounce
