ab = AB
age = Age
aggressive_free_swinger = Aggressive Free Swinger
...
c = C
catching = Catching
catching_success_rate = Catching Success Rate
catch_play = Catch Play
catcher = Catcher
center_fielder = Center Fielder
cf = CF
changeup = Changeup
classic_analyst = Classic Analyst
clutch = Clutch
...
inning_top = Top
infielder = Infielder
inside_dominant = Inside Dominant
...
loss = Loss
losses = Losses
low_baller = Low Baller
main_menu = Main Menu
middle_infielder = Middle Infielder
mistake_pitch_rate = Mistake Pitch Rate
na = N/A
...
outside_dominant = Outside Dominant
overhand = Overhand
p = P
pct = PCT
pitcher = Pitcher
