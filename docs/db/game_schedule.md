...
| sqlite_autoindex_game_schedule_1 | PRIMARY KEY | PRIMARY KEY (game_round_season, game_round_seq, seq, away_team_id, home_team_id) |

## Indexes

| Name                             | Definition                                                                       |
| -------------------------------- | -------------------------------------------------------------------------------- |
| sqlite_autoindex_game_schedule_1 | PRIMARY KEY (game_round_season, game_round_seq, seq, away_team_id, home_team_id) |

## Relations

![er](game_schedule.svg)
