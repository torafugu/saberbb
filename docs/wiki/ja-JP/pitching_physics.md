# Spatial coordinates of Ball Location
...
- 右投手の場合：
  - スライダー（反時計回り）：基本軸から 「マイナス方向（左へ）」 ひねる
  - シュート・チェンジアップ（時計回り）：基本軸から 「プラス方向（右へ）」 ひねる

- 左投手の場合：
  - スライダー（時計回り）：基本軸から 「プラス方向（右へ）」 ひねる
  - シュート・チェンジアップ（反時計回り）：基本軸から 「マイナス方向（左へ）」 ひねる
